...
with orders as (
    ...
    select * from {{ ref('stg_merlinco_apothecaries__orders') }}
...
customers as (
    ...
    select * from {{ ref('stg_merlinco_apothecaries__customers') }}

),

current_guild_memberships as (

    select * from {{ ref('int_guild_memberships_current') }}

),

shops as (

    select * from {{ ref('stg_merlinco_apothecaries__shops') }}
