...
customer_memberships as (

    select * from {{ ref('int_customers_current_guild_membership') }}
...
final as (
    ...
    select
        ...
        customer_memberships.guild_id,
        customer_memberships.guild_tier,
        orders.shop_id,
        shops.shop_name,
        ...
        customers.home_region = shops.shop_region as is_home_region_order,
    ...
    left join customer_memberships
        on orders.customer_id = customer_memberships.customer_id
    left join shops
